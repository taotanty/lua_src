...
#+END_SRC
2.[[file:~/code/lua_src/lua_src/lstate.h::157][lua_State]], 每个线程的状态状态,具体介绍见[[http://blog.csdn.net/chenjiayi_yun/article/details/24304607][博客]]
#+BEGIN_SRC C
/*
 ** 'per thread' state
*/
...
** lua常用接口
n
1. lua_pcall 在lua.h中[[file:/Users/a515/code/lua_src/lua_src/lua.h::270][定义]] 但是实际上是用lua_pcallk去实现调用的
#+BEGIN_SRC C
...
#+END_SRC
4. [[file:/Users/a515/code/lua_src/lua_src/lauxlib.h][luaL_newstate]]
#+BEGIN_SRC C
